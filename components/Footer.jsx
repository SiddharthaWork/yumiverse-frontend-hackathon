...
export default function Footer() {
  return (
    <footer className="bg-neo-teal border-t-2 border-black py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="md:col-span-1">
            ...
            <div className="flex space-x-4">
              <Link href="#" className="w-12 h-12 rounded-full border-2 bg-white hover:bg-transparent border-black flex items-center justify-center">
                <Facebook size={16} />
              </Link>
              <Link href="#" className="w-12 h-12 rounded-full border-2 border-black bg-white hover:bg-transparent flex items-center justify-center">
                <Instagram size={16} />
              </Link>
              <Link href="#" className="w-12 h-12 rounded-full border-2 border-black bg-white hover:bg-transparent flex items-center justify-center">
                <Youtube size={16} />
      ...
      <div className="flex justify-center mt-8 rotate-180">
